...
class CreateProductForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['brand'].disabled = True if self.initial.get(
            'isBranded') == True else False
        self.fields['brand'].disabled = True if self.initial.get(
            'isBranded') == True else False
    ...
    class Meta:
        model = Product
        fields = ['title', 'collection', 'year', 'quantity', 'type',
                  'flag', 'brand', 'size', 'price', 'front_image', 'back_image']
        widgets = {
